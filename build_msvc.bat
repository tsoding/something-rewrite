...
set LIBS=dependencies\SDL2\lib\x64\SDL2.lib dependencies\SDL2\lib\x64\SDL2main.lib dependencies\GLFW\lib\glfw3.lib dependencies\GLEW\lib\glew32s.lib opengl32.lib User32.lib Gdi32.lib Shell32.lib
